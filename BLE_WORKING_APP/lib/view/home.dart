...
// import 'package:virush/controller/health_data_controller.dart';
import 'package:virush/view/heartrateChart.dart';
import 'package:virush/view/spo2Chart.dart';
import '/view/takeTest.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:get/get.dart';
import 'package:flutter_blue_plus/flutter_blue_plus.dart';
import 'package:virush/view/bodytempChart.dart';
...
class _HomeState extends State<Home> {
  ...
  void didUpdateWidget(covariant Home oldWidget) {
    ...
    // Fetch data from the database when the widget is updated
    fetchLatestRecord();
    runAfterDelay();
  }
  ...
  @override
  void didPush() {
    // Fetch the latest record when you navigate back to the Home Screen
    fetchLatestRecord();
    runAfterDelay();
  }
  ...
  BluetoothDevice? _device; // Placeholder variable for the Bluetooth device
