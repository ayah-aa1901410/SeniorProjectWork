...
class _RecordsState extends State<Records> {
  ...
  Future<void> addRecord() async {
    ...
    final Map<String, dynamic> data = <String, dynamic>{
      'uid': _user.uid, // Add the current user ID
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    // const SizedBox(width: 10),
                    // Text('Vital Signs Status: ${data['stat_ml_result']}'),
                  ],
                ),
                //heart
                Row(
                  children: [
                    ...
                    //const SizedBox(width: 20),
                    // const FaIcon(FontAwesomeIcons.headSideCough,
                    //     size: 20, color: Colors.blueGrey),
                    // const SizedBox(width: 10),
                    // Text('Cough Sound Result: ${data['cough_sound_result']}'),
                  ],
                ),
                //body temp
                Row(
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          recordsController
                              .getStyledText(data['cough_sound_result']),
                        ],
                      ),
                    ),
                    //Text('Cough Sound Result: ${data['cough_sound_result']}'),
...
* -uid
		-date&time
		-coughsoundrsultt "healthy, covid19"
		-spo2
		-heartrate
		-body temperature
		-stat_ml_result
...
//   //     return Card(
//   //       child: ListTile(
//   //         title: Text(record['cough_sound_result']),
//   //         subtitle: Text(record['stat_ml_result']),
//   //         trailing: Text(record['overall_health']),
//   //       ),
//   //     );
//   //   }).toList(),
//   // );
...
// Future<QuerySnapshot<Object?>> getUserRecords() async {
//   final CollectionReference recordsRef =
//       FirebaseFirestore.instance.collection('records');
//
//   // Query the 'records' collection to get all documents with a matching user ID
//   final QuerySnapshot snapshot =
//       await recordsRef.where('uid', isEqualTo: _user.uid).get();
//
