# -*- coding: utf-8 -*-
"""
Created on Fri Dec  9 21:22:51 2022
...
model = RandomForestClassifier(n_estimators=150, max_depth=None, criterion='gini', verbose=1)
# ,  min_samples_split=2
...
with open('MFCC_from_WAV_RFC_Model_01.pkl','wb') as f:
        pickle.dump(model, f)
