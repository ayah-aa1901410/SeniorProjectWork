...
# import tensorflow.keras.utils.normalize as norms
...
def my_f1(y_true, y_pred):
    return f1_score(y_true, y_pred, average="f1_weighted")[1]


def my_roc_auc(y_true, y_pred):
    return roc_auc_score(y_true, cv2.normalize(y_pred,None, alpha=0, beta=1, 
                            norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F), average="roc_auc_ovr_weighted")
