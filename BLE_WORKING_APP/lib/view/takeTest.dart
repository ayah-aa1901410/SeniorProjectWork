...
class _TakeTestState extends State<TakeTest> {
  ...
  Future<void> classifyAudio() async {
    ...
    // String url = "http://192.168.100.105:8000/predict";
    // String url = "http://10.75.46.151:8000/predict";
    String url = "http://10.75.46.143:7000/predict";
  ...
  Future<void> classifyHealthData() async {
    ...
    // String _url = "http://192.168.100.105:8000/classify";
    // String _url = "http://10.75.46.151:8000/classify";
    String _url = "http://10.75.46.143:7000/classify";
            ...
            _tempCharacteristic!.value.listen((value) {
              ...
              setState(() {
                ...
                if(bodytemperature.text == '-1'){
                  bodytemperature.text = tempList[2].toString();
                  print("Body Temp: ");
                  print(tempList[2].toString());
                }
            ...
            _pulseCharacteristic!.value.listen((value) {
              ...
              setState(() {
                ...
                if(pulseText != 4294966297 && pulseText != 0){
                  ...
                  if(heartrate.text == '-1'){
                    heartrate.text = pulseList[2].toString();
                    print("Heart Rate: ");
                    print(pulseList[2].toString());
                  }
                }
                if(spo2.text != '-1' && bodytemperature.text != '-1' && heartrate.text != '-1' && counter == 0){ //
                  print("inside the if statement");
            ...
            _spo2Characteristic!.value.listen((value) {
              ...
              setState(() {
                ...
                if(spo2Text != 4294966297 && spo2Text != 0){
                  ...
                  if(spo2.text == '-1'){
                    spo2.text = spo2List[2].toString();
                    print("Spo2: ");
                    print(spo2List[2].toString());
                  }
                  if(spo2.text != '-1' && bodytemperature.text != '-1' && heartrate.text != '-1' && counter == 0){ //
                    print("inside the if statement");
                    classifyHealthData();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Take Test', style: TextStyle(fontSize: 23, fontFamily: 'Roboto', fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Visibility(
                                  visible: !_hideHealthData && _NFCconnected && (bodytemperature.text == "-1" || spo2.text == "-1" || heartrate.text == "-1"),
                                  child: Text(
                                    "Calibrating data ....",
                                    style: TextStyle(fontSize: 18, color: Color.fromRGBO(65 , 161, 145, 1.0)),
                                  ),
                                ),
                                Visibility(
                                    visible: _hideHealthData,
