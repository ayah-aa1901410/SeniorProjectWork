                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            style: const TextStyle(fontSize: 20, color: Color.fromRGBO(125, 125, 125, 1.0)),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 15.0,
                                  color: const Color.fromRGBO(105, 105, 105, 1.0),
                                ),
                              ),
                              //dropdown
                              DropdownButton(
                                ...
                                selectedItemBuilder: (BuildContext context) {
                                  return <String>[
                                    ...
                                    return ClipRRect(
                                      ...
                                      child: Text(
                                        _gender,
                                        style: const TextStyle(fontSize: 15, color: Color.fromRGBO(105, 105, 105, 1.0)),
                                      ),
                                    ),
                                    );
                                  }).toList();
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style:
                              TextStyle(fontSize: 18, color: Colors.red[100]),
                        ),
                        TextButton(
                          child: Text(
                            'Log in',
