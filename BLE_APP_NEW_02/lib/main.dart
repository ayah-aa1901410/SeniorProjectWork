...
class FindDevicesScreen extends StatelessWidget {
  ...
  // will be called once the application screen/home is created. This will scan for the available devices.
  // it will display a list that has the results of the scanning
  ...
  // if the previous function is scanning correctly, then the button will have a "STOP" sign, to stop the scanning. If there is no scanning going on, then the button will have
  // Connect to Wristband -- written on it.
